    ...
    <Box sx={{ bgcolor: '#f9fafc', minHeight: '100vh' }}>
      ...
      <AppBar position="sticky" sx={{ bgcolor: '#673ab7' }}>
        <Toolbar>
          ...
          <IconButton color="inherit" onClick={toggleAside}>
            <Avatar src={user?.image ? `data:image/jpeg;base64,${user.image}` : '/assets/imagen_defecto.jpeg'} />
          </IconButton>
        </Toolbar>
      </AppBar>
      ...
      <Drawer anchor="right" open={showAside} onClose={toggleAside}>
        <Box sx={{ width: 300, p: 3 }}>
          ...
          <Box textAlign="center">
            <Avatar
              src={user?.image ? `data:image/jpeg;base64,${user.image}` : '/assets/imagen_defecto.jpeg'}
            ...
            {user ? (
              <>
                ...
                <Button variant="outlined" color="error" fullWidth startIcon={<LogoutIcon />} onClick={handleLogOut} sx={{ mt: 1 }}>
                  Logout
                </Button>
              </>
            ) : (
              <>
                <Button variant="contained" color="success" fullWidth startIcon={<LoginIcon />} component={Link} to="/userLogin" sx={{ mt: 2 }}>
                  Login
                </Button>
                <Button variant="outlined" color="primary" fullWidth startIcon={<PersonAddIcon />} component={Link} to="/userRegister" sx={{ mt: 1 }}>
                  Register
                </Button>
              </>
            )}
        ...
        >
          ...
          >
            <Typography variant="h6" sx={{ mb: 4 }}>
              Embark on a journey to learn Math, Science, Art, and more with engaging content.
            </Typography>
          </motion.div>
          <motion.div
