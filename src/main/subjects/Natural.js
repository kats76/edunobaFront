  ...
  return (
    <div className="natural-container">
      ...
      <div className="math-content text-white d-flex flex-column justify-content-center align-items-center">
        <h1 className="fw-bold">Natural Sciences - Content Blocks</h1>
        <p className="text-center">
          Welcome to the exciting world of Natural Sciences! Let's explore the key topics we'll cover in this course.
        </p>
        <ul className="list-group list-group-flush bg-transparent text-white">
          <li className="list-group-item bg-transparent text-white">
            <i className="bi bi-check-circle"></i>{' '}
            <Link className="text-white text-decoration-none" to="/body-health">
              The Human Body and Health
            </Link>
          </li>
          <li className="list-group-item bg-transparent text-white">
            <i className="bi bi-check-circle"></i>{' '}
            <Link className="text-white text-decoration-none" to="/diversity-interactions">
              Living Things: Diversity and Interactions
            </Link>
          </li>
          <li className="list-group-item bg-transparent text-white">
            <i className="bi bi-check-circle"></i>{' '}
            <Link className="text-white text-decoration-none" to="/matter-energy">
              Matter and Energy
            </Link>
          </li>
          <li className="list-group-item bg-transparent text-white">
            <i className="bi bi-check-circle"></i>{' '}
            <Link className="text-white text-decoration-none" to="/technology-machines">
              Technology and Machines
            </Link>
          </li>
          <li className="list-group-item bg-transparent text-white">
            <i className="bi bi-check-circle"></i>{' '}
            <Link className="text-white text-decoration-none" to="/earth-universe">
              The Earth and the Universe
            </Link>
          </li>
          <li className="list-group-item bg-transparent text-white">
            <i className="bi bi-check-circle"></i>{' '}
            <Link className="text-white text-decoration-none" to="/awarness-sustainability">
