  ...
  return (
    <div className="social-container">
      ...
      <div className="math-content text-white d-flex flex-column justify-content-center align-items-center">
        <h1 className="fw-bold">Social Sciences - Content Blocks</h1>
        <p className="text-center">
          Welcome to the exciting world of Social Sciences! Let's explore the key topics we'll cover in this course.
        </p>
        <ul className="list-group list-group-flush bg-transparent text-white">
          <li className="list-group-item bg-transparent text-white">
            <i className="bi bi-check-circle"></i>{' '}
            <Link className="text-white text-decoration-none" to="/time">
              The Passage of Time and Historical Notions
            </Link>
          </li>
          <li className="list-group-item bg-transparent text-white">
            <i className="bi bi-check-circle"></i>{' '}
            <Link className="text-white text-decoration-none" to="/geography">
              Geography and Spatial Representation
            </Link>
          </li>
          <li className="list-group-item bg-transparent text-white">
            <i className="bi bi-check-circle"></i>{' '}
            <Link className="text-white text-decoration-none" to="/society-culture">
              Society and Culture
            </Link>
          </li>
          <li className="list-group-item bg-transparent text-white">
            <i className="bi bi-check-circle"></i>{' '}
            <Link className="text-white text-decoration-none" to="/economy">
              Economy and Sustainable Development
            </Link>
          </li>
          <li className="list-group-item bg-transparent text-white">
            <i className="bi bi-check-circle"></i>{' '}
            <Link className="text-white text-decoration-none" to="/citizenship">
